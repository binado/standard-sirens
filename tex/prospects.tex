...
\begin{itemize}
\item Not all redshifts are equally probable, we expect a source distribution
  to follow somehow the Madau-Dickinson one \cite{Madau:2014bja}: 
  \be
  R(z)=\frac{dV}{dz}\psi(z)
  \ee
  where
  \be
  \psi(z)=C_0\frac{(1+z)^\alpha}{\paq{1+\frac{1+z}B}^{\beta}}yr^{-1}Gpc^{-3}
  \ee
