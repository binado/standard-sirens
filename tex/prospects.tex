...
that each galaxy is a candidate host for the CBC, and hence the merger's redshift is equal to that
of the galaxy's. We can model the catalog data as an array
