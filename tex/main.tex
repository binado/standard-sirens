...
\begin{figure}[!ht]
	\caption{\textit{Left:} a histogram of the galaxy number count per redshift bin in the (whole-sky) catalog we consider. \textit{Right:} the same histogram for all galaxies up to $z=1.5$.}
	\centering
...
and we fix $z_\text{max} = 1.4$ and $d_L^{\rm{th}} = 1550 \,$Mpc.
...
This manuscript is intended as a pedagogical introduction to gravitational-wave standard sirens as
cosmological probes.
